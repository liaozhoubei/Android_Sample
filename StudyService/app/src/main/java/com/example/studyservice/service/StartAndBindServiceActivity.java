...
/**
 * 演示 startService 和 bindService 的异同
 */
public class StartAndBindServiceActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_bind_service);
