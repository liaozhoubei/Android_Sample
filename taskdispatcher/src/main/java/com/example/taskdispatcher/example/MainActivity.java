...
import com.example.taskdispatcher.DelayInitDispatcher;
import com.example.taskdispatcher.R;
import com.example.taskdispatcher.example.adapter.NewsAdapter;
import com.example.taskdispatcher.example.adapter.OnFeedShowCallBack;
import com.example.taskdispatcher.example.bean.NewsItem;
import com.example.taskdispatcher.example.net.RetrofitNewsUtils;
import com.example.taskdispatcher.example.tasks.delayinittask.DelayInitTaskA;
import com.example.taskdispatcher.example.tasks.delayinittask.DelayInitTaskB;
...
//                });
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("banner.json");
