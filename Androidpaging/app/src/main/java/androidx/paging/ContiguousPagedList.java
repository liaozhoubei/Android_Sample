    ...
    PageResult.Receiver<V> mReceiver = new PageResult.Receiver<V>() {
        ...
        public void onPageResult(@PageResult.ResultType int resultType,
            ...
            if (mBoundaryCallback != null) {
                ...
                Log.e("MyPaging", "ContiguousPagedList onPageResult: mStorage.size():" + mStorage.size()+
                        "  resultType:"+ resultType +
                        "  pageResult.page.size():" + pageResult.page.size() +
                        "  deferBegin:" + deferBegin);
                Log.e("MyPaging", "ContiguousPagedList  ************* " );
